<?php
 ...
 echo '<script>window.location="sree.php"</script>';
 }
 }
 else
 {
 ...
 <html>
 <head>
 <title>Indian Cuisine Ordering</title>
 ...
 <h3 align="center">AVALIABLE INDIAN ITEMS FOR ONLINE ORDERING</h3>
 <br /> 
 <?php 
 ...
 ?>
 <div class="col-md-4"> 
 <form method="post" action="sree.php?action=add&id=<?php echo $row["id"]; ?>">
 ...
 <td><a href="sree.php?action=delete&id=<?php echo $values["item_id"]; ?>">
 ...
 <div align="center">
  <input type="submit" onclick="<?php $_SESSION['finalPrice']+=$total ?>" >
   <input type="submit" style="float:right" value="Continue" onclick='location.href="conte.html" '></div>
 </div>
 <br />
 </body>
 </html>

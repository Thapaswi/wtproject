<?php
 ...
 echo '<script>window.location="sree1.php"</script>';
 }
 }
 else
 {
 ...
 <html>
 <head>
 <title>Continental Food Ordering</title>
 ...
 <h3 align="center">AVALIABLE CONTINENT ITEMS FOR ONLINE ORDERING</h3>
 <br /> 
 <?php 
 ...
 ?>
 <div class="col-md-4"> 
 <form method="post" action="sree1.php?action=add&id=<?php echo $row["id"]; ?>">
 ...
 <input type="number" min="0" max="10" name="quantity" class="form-control" placeholder="enter quantity">
 ...
 <td><a href="sree1.php?action=delete&id=<?php echo $values["item_id"]; ?>">
 ...
 <div align="center">
 <input type="submit" style="float:left" value="BACK" onclick='location.href="sree.php" '>
  <input type="submit" onclick="<?php $_SESSION['finalPrice']+=$total ?>" >
   <input type="submit" style="float:right" value="PAY" onclick='location.href="tq1.php" '></div>
 </div>
 <br />
 </body>
 </html>
